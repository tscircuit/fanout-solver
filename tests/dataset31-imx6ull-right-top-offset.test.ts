...
import fixture from "./fixtures/dataset31-imx6ull-right-top-offset.json"
import { FanoutSolver } from "../lib/fanout-solver"
import { getLayerReservedBusTargets } from "../lib/route-layer-reserved-buses"
import { validateRoutedCopperDrc } from "../lib/validate-routed-copper-drc"

test("repairs successive constrained pairs and a final bus with new source reservations", async () => {
