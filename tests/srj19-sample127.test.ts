...
const sample = srj19FanoutSamples.find(({ id }) => id === "sample127")
if (!sample) throw new Error("SRJ19 sample127 is missing")

test("SRJ19 sample127 solves on six layers", async () => {
