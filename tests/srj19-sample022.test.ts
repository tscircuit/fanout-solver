...
const sample = srj19FanoutSamples.find(({ id }) => id === "sample022")
if (!sample) throw new Error("SRJ19 sample022 is missing")

test("SRJ19 sample022 shares fanout copper from the same source port", async () => {
