...
import capturedSample from "./fixtures/dataset31-top-left-offset.json"
...
test("routes a centered layered bus beside a constrained corner band", async () => {
  ...
  expect(solver.attempts[0]?.busLayerAssignments.DDR_BYTE1).toBe("bottom")
