...
import fixture from "./fixtures/dataset31-imx6ull-bottom-center.json"
import { FanoutSolver } from "../lib/fanout-solver"
import { validateRoutedCopperDrc } from "../lib/validate-routed-copper-drc"

test("relocates the short DDR lane first via to complete the original i.MX6ULL bottom-center fanout", async () => {
