...
import fixture from "./fixtures/dataset31-imx6ull-top-right-offset.json"
import { FanoutSolver } from "../lib/fanout-solver"
import { validateRoutedCopperDrc } from "../lib/validate-routed-copper-drc"

test("retains future approaches with a higher source cost after the fresh source retry cannot route", async () => {
