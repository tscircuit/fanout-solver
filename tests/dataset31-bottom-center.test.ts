...
import capturedSample from "./fixtures/dataset31-bottom-center.json"
...
test("routes the raw dataset31 bottom-center sample with adaptive plane reservation repair", async () => {
