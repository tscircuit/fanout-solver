...
import capturedSample from "./fixtures/dataset31-right-top-offset.json"
...
test("routes raw dataset31 right-top with separated layered exits and reserved singleton vias", async () => {
