...
import capturedSample from "./fixtures/dataset31-right-bottom-offset.json"
...
test("reserves source escapes for embedded singletons on different target layers", async () => {
