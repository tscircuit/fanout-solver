...
test("uses joint boundary via reservation for bounded dense groups through eight buses", () => {
...
test("keeps topology diversity bounded in dense five- through eight-bus paths", () => {
  expect(
    shouldSearchAdditionalBoundaryRouteTopologies({
      boundaryBusCount: 4,
      connectionCount: 8,
