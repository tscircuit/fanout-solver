...
test("uses joint boundary via reservation for bounded dense groups through seven buses", () => {
...
test("defers exactly one singleton dogbone in the five- through seven-bus paths", () => {
...
test("keeps topology diversity bounded in dense five- through seven-bus paths", () => {
  expect(
    shouldSearchAdditionalBoundaryRouteTopologies({
      boundaryBusCount: 4,
      connectionCount: 8,
